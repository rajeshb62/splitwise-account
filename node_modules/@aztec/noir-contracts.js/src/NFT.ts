...
export class NFTContract extends ContractBase {
  ...
  public declare methods: {
    ...
    constructor: ((admin: AztecAddressLike, name: string, symbol: string) => ContractFunctionInteraction) &
      Pick<ContractMethod, 'selector'>;

    /** finalize_transfer_to_private(token_id: field, hiding_point_slot: field) */
    finalize_transfer_to_private: ((token_id: FieldLike, hiding_point_slot: FieldLike) => ContractFunctionInteraction) &
      Pick<ContractMethod, 'selector'>;
    ...
    get_private_nfts: ((owner: AztecAddressLike, page_index: bigint | number) => ContractFunctionInteraction) &
      Pick<ContractMethod, 'selector'>;
    ...
    prepare_transfer_to_private: ((to: AztecAddressLike) => ContractFunctionInteraction) &
      Pick<ContractMethod, 'selector'>;
    ...
    transfer_to_private: ((to: AztecAddressLike, token_id: FieldLike) => ContractFunctionInteraction) &
      Pick<ContractMethod, 'selector'>;
