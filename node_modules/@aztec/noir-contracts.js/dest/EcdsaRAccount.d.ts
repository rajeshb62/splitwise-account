 ...
 */
export declare class EcdsaRAccountContract extends ContractBase {
    private constructor();
    /**
     ...
     */
    static at(address: AztecAddress, wallet: Wallet): Promise<EcdsaRAccountContract>;
    /**
     * Creates a tx to deploy a new instance of this contract.
     */
    static deploy(wallet: Wallet, signing_pub_key_x: (bigint | number)[], signing_pub_key_y: (bigint | number)[]): DeployMethod<EcdsaRAccountContract>;
    /**
     * Creates a tx to deploy a new instance of this contract using the specified public keys hash to derive the address.
     */
    static deployWithPublicKeys(publicKeys: PublicKeys, wallet: Wallet, signing_pub_key_x: (bigint | number)[], signing_pub_key_y: (bigint | number)[]): DeployMethod<EcdsaRAccountContract>;
    /**
     * Creates a tx to deploy a new instance of this contract using the specified constructor method.
     */
    static deployWithOpts<M extends keyof EcdsaRAccountContract['methods']>(opts: {
        publicKeys?: PublicKeys;
        method?: M;
        wallet: Wallet;
    }, ...args: Parameters<EcdsaRAccountContract['methods'][M]>): DeployMethod<EcdsaRAccountContract>;
    /**
...
//# sourceMappingURL=EcdsaRAccount.d.ts.map