 ...
 */
export declare class EcdsaKAccountContract extends ContractBase {
    private constructor();
    /**
     ...
     */
    static at(address: AztecAddress, wallet: Wallet): Promise<EcdsaKAccountContract>;
    /**
     * Creates a tx to deploy a new instance of this contract.
     */
    static deploy(wallet: Wallet, signing_pub_key_x: (bigint | number)[], signing_pub_key_y: (bigint | number)[]): DeployMethod<EcdsaKAccountContract>;
    /**
     * Creates a tx to deploy a new instance of this contract using the specified public keys hash to derive the address.
     */
    static deployWithPublicKeys(publicKeys: PublicKeys, wallet: Wallet, signing_pub_key_x: (bigint | number)[], signing_pub_key_y: (bigint | number)[]): DeployMethod<EcdsaKAccountContract>;
    /**
     * Creates a tx to deploy a new instance of this contract using the specified constructor method.
     */
    static deployWithOpts<M extends keyof EcdsaKAccountContract['methods']>(opts: {
        publicKeys?: PublicKeys;
        method?: M;
        wallet: Wallet;
    }, ...args: Parameters<EcdsaKAccountContract['methods'][M]>): DeployMethod<EcdsaKAccountContract>;
    /**
...
//# sourceMappingURL=EcdsaKAccount.d.ts.map