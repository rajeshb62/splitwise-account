import { AztecAddress, type AztecAddressLike, type ContractArtifact, ContractBase, ContractFunctionInteraction, type ContractMethod, DeployMethod, type FieldLike, type FunctionSelectorLike, PublicKeys, type Wallet } from '@aztec/aztec.js';
...
export declare class SchnorrHardcodedAccountContract extends ContractBase {
     ...
     */
    static deployWithPublicKeys(publicKeys: PublicKeys, wallet: Wallet): DeployMethod<SchnorrHardcodedAccountContract>;
    /**
