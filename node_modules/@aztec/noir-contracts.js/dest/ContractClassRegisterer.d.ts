import { AztecAddress, type AztecAddressLike, type ContractArtifact, ContractBase, ContractFunctionInteraction, type ContractMethod, DeployMethod, type FieldLike, type FunctionSelectorLike, PublicKeys, type Wallet, type WrappedFieldLike } from '@aztec/aztec.js';
...
export declare class ContractClassRegistererContract extends ContractBase {
     ...
     */
    static deployWithPublicKeys(publicKeys: PublicKeys, wallet: Wallet): DeployMethod<ContractClassRegistererContract>;
    /**
