...
export type CircuitName = 'base-parity' | 'root-parity' | 'base-rollup' | 'merge-rollup' | 'block-root-rollup' | 'empty-block-root-rollup' | 'block-merge-rollup' | 'root-rollup' | 'private-kernel-init' | 'private-kernel-inner' | 'private-kernel-reset' | 'private-kernel-tail' | 'private-kernel-tail-to-public' | 'app-circuit' | 'public-kernel-inner' | 'public-kernel-merge' | 'public-kernel-tail' | 'avm-circuit' | 'empty-nested' | 'private-kernel-empty' | 'tube-circuit';
...
export type Stats = AvmSimulationStats | CircuitProvingStats | CircuitSimulationStats | CircuitWitnessGenerationStats | PublicDBAccessStats | L1PublishBlockStats | L1PublishProofStats | L2BlockBuiltStats | L2BlockHandledStats | NodeSyncedChainHistoryStats | NoteProcessorCaughtUpStats | ProofConstructed | TreeInsertionStats | TxAddedToPoolStats;
