import { type AztecAddress, type CompleteAddress, type ContractClassWithId, type ContractInstanceWithAddress, type Fr, type L1_TO_L2_MSG_TREE_HEIGHT, type NodeInfo, type PartialAddress, type Point, type ProtocolContractAddresses } from '@aztec/circuits.js';
...
import { type GetUnencryptedLogsResponse, type L1EventPayload, type LogFilter, type UnencryptedL2Log } from '../logs/index.js';
...
export interface PXE {
     ...
     * Also throws if simulatePublic is true and public simulation reverts.
     */
    simulateTx(txRequest: TxExecutionRequest, simulatePublic: boolean, msgSender?: AztecAddress, skipTxValidation?: boolean, scopes?: AztecAddress[]): Promise<TxSimulationResult>;
    /**
