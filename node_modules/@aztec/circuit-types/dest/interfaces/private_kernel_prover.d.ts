...
/// <reference types="node" resolution-mode="require"/>
import { type ClientIvcProof, type PrivateKernelCircuitPublicInputs, type PrivateKernelInitCircuitPrivateInputs, type PrivateKernelInnerCircuitPrivateInputs, type PrivateKernelResetCircuitPrivateInputs, type PrivateKernelTailCircuitPrivateInputs, type PrivateKernelTailCircuitPublicInputs, type VerificationKeyAsFields } from '@aztec/circuits.js';
...
export interface PrivateKernelProver {
     ...
     */
    simulateProofInit(privateKernelInputsInit: PrivateKernelInitCircuitPrivateInputs): Promise<PrivateKernelSimulateOutput<PrivateKernelCircuitPublicInputs>>;
    /**
     ...
     * @returns A Promise resolving to a ProofOutput object containing public inputs and the kernel proof.
     */
    simulateProofInner(privateKernelInputsInner: PrivateKernelInnerCircuitPrivateInputs): Promise<PrivateKernelSimulateOutput<PrivateKernelCircuitPublicInputs>>;
    /**
     ...
     * @returns A Promise resolving to a ProofOutput object containing public inputs and the kernel proof.
     */
    simulateProofReset(privateKernelInputsReset: PrivateKernelResetCircuitPrivateInputs): Promise<PrivateKernelSimulateOutput<PrivateKernelCircuitPublicInputs>>;
    /**
     ...
     * @returns A Promise resolving to a ProofOutput object containing public inputs and the kernel proof.
     */
    simulateProofTail(privateKernelInputsTail: PrivateKernelTailCircuitPrivateInputs): Promise<PrivateKernelSimulateOutput<PrivateKernelTailCircuitPublicInputs>>;
    /**
