...
export declare class TimeoutTask<T> {
    ...
    private interrupt;
    private totalTime;
    constructor(fn: () => Promise<T>, timeout?: number, fnName?: string, error?: () => Error);
    /**
...
export declare const executeTimeoutWithCustomError: <T>(fn: () => Promise<T>, timeout?: number, error?: () => Error, fnName?: string) => Promise<T>;
